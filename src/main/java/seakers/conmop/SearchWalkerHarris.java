...
import seakers.conmop.io.WalkerVariableWriter;
 ...
 * @author nozomihitomi
 */
public class SearchWalkerHarris {
    ...
    public static void main(String[] args) throws OrekitException {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            EpsilonBoxDominanceArchive archive = new EpsilonBoxDominanceArchive(new double[]{10, 1});
            ...
            operators.add(new OrbitElementOperator(
                    new CompoundVariation(new SBX(1, 20), new PM(1, 20))));
...
//                }
            ...
            // Initialize population writer
            WalkerVariableWriter writer = new WalkerVariableWriter();
